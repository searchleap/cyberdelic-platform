...
function TenantInputs({ defaultValues }: { defaultValues?: { subdomain?: string; name?: string } }) {
  return (
        ...
        <div className="flex items-center">
          <div className="relative flex-1">
            <Input
              ...
              defaultValue={defaultValues?.subdomain}
...
export function TenantForm() {
  ...
  return (
    <form action={action} className="space-y-4">
      <TenantInputs defaultValues={{ subdomain: state?.subdomain, name: '' }} />
